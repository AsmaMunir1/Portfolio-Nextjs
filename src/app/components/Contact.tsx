      ...
      <div className='grid md:grid-cols-2 gap-10'>
        ...
        <div className='space-y-8'>
            <div className='flex flex-col gap-1' data-aos="zoom-in-up">
                ...
                <input type="text" 
                className='h-[40px] bg-transparent border border-[#017728]'
                id='name'/>
            </div>
            <div className='flex flex-col gap-1' data-aos="zoom-in-up">
            ...
            <div className='flex flex-col gap-1' data-aos="zoom-in-up">
                ...
                <textarea  
                className='bg-transparent border border-[#017728]'
                id='msg' rows={8}>
                </textarea >
            </div>
            <button className='bg-[#017728] p-2 px-6 text-white' data-aos="zoom-in-up">Submit</button>
        </div>
      </div>
    </div>
  )
